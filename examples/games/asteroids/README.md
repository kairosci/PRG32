...
This directory contains two RISC-V assembly versions of an Asteroids-inspired
PRG32 demo:
...
The source is intentionally verbose and uses only simple PRG32 framework calls
so students can trace registers, memory variables, and C helper calls in the
debugger.
